...
let coordinates = map.on('click', function(e) {
...
document.getElementById("city_selec_form").addEventListener("submit", function(event) {
    ...
    if (place_name = null){
        console.log(coordinates)
        API_OPEN_METEO = `https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${coordinates[1]}&longitude=${coordinates[0]}&hourly=pm10,pm2_5`
